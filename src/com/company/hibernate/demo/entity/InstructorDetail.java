...
public class InstructorDetail {
  ...
  //Add a reference to the Instructor table.
...
//    @OneToOne(mappedBy = "instructorDetail", cascade = CascadeType.ALL)
  ...
  //mappedBy = "instructorDetail" refers/points to the instructor details property(instructorDetail)  in the instructor class.
  //It means the instructor property/field is mapped by the instructorDetails property in the Instructor class.
